...
namespace Versum.Dtos
{
    public class UserProfileDto
    {
        ...
        [MaxLength(30, ErrorMessage = "Поле імені неможе містити більше 30-ти символів")]
        public string Name {  get; set; } = string.Empty;

        [Required(ErrorMessage = "Введіть свою біографію")]
        [MaxLength(200, ErrorMessage = "Поле біографії неможе містити більше 200-ти символів")]
